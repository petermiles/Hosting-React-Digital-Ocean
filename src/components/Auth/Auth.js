  ...
  render() {
    return (
      <div>
        ...
        <a href={ process.env.REACT_APP_BASEURL + '/api/auth/login' }>Login/Register</a>
        <p>
          With create-react-app applications, we can pull in enviromnet variables from a .env file so long as they start with REACT_APP_  .  So in this build our REACT_APP_BASEURL is - { process.env.REACT_APP_BASEURL  } -
        </p>
        <p>
